    ...
    BX.Otus.Autoservice.Garage.create(<?=CUtil::PhpToJSObject(
        [
            ...
            'messages' => [
                ...
                'historyTitle' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_TITLE'),
                'historyLoading' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_LOADING'),
                'historyEmpty' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_EMPTY'),
                'historyDate' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_DATE'),
                'historyStage' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_STAGE'),
                'historyAssigned' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_ASSIGNED'),
                'historyAmount' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_AMOUNT'),
                'historyParts' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_PARTS'),
                'historyNoParts' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_NO_PARTS'),
                'historyProduct' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_PRODUCT'),
                'historyQuantity' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_QUANTITY'),
                'historyPrice' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_PRICE'),
                'historySum' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_SUM'),
                'historyOpenDeal' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_OPEN_DEAL'),
                'historyLoadMore' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_LOAD_MORE'),
                'historyClose' => Loc::getMessage('OTUS_AUTOSERVICE_GARAGE_HISTORY_CLOSE'),
            ],
        ]
    )?>);
});
