...
$MESS['OTUS_AUTOSERVICE_OPTIONS_STOCK_PROVIDER_HELP'] = 'Поставщик возвращает абсолютное количество, после чего синхронизация применяет его штатным API каталога.';
$MESS['OTUS_AUTOSERVICE_OPTIONS_STOCK_PROVIDER_INVALID'] = 'Выбран неизвестный источник внешних остатков.';
$MESS['OTUS_AUTOSERVICE_OPTIONS_STOCK_RESPONSIBLE'] = 'Ответственный складских документов (ID)';
$MESS['OTUS_AUTOSERVICE_OPTIONS_STOCK_RESPONSIBLE_HELP'] = 'Нужен фоновому cron только при включённом складском учёте. Ручной запуск использует текущего активного пользователя, если поле пустое.';
$MESS['OTUS_AUTOSERVICE_OPTIONS_STOCK_RESPONSIBLE_INVALID'] = 'Укажите ID существующего активного пользователя для складских документов.';
